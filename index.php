...
<main class="top-page">
    ...
    <section class="assisted-living-facility top-section-wrapper">
        <div class="top-section-title">
            <h4 class="font28">ASSISTED LIVING FACILITY</h4>
            <h5 class="font20">有料老人ホーム</h5>
        </div>
        <p class="font16 my-4">
        ...
        <div class="font14 mt-2">愛知県岡崎市伝馬通1丁目78番地</div>
    </section>
    <section class="group-home top-section-wrapper">
        <div class="top-section-title">
            <h4 class="font28">GROUPHOME</h4>
            <h5 class="font20">グループホーム</h5>
        </div>
        <p class="font16 my-4">
        ...
        <div class="top-section-viewer special">
            ...
            <a href="<?php echo esc_url( home_url() ); ?>/grouphome-fukuoka/">
                ...
                <div class="font14 mt-2">愛知県岡崎市福岡町字通長36番地</div>
            </a>
            <a href="<?php echo esc_url( home_url() ); ?>/grouphome-mutsumi/">
                ...
                <div class="font14 mt-2">愛知県岡崎市赤渋町寺前19番地1</div>
            </a>
        </div>
    </section>
    <section class="day-care-service top-section-wrapper">
        <div class="top-section-title">
            <h4 class="font28">DAY CARE SERVICE</h4>
            <h5 class="font20">デイサービス</h5>
        </div>
        <p class="font16 my-4">
        ...
        <div class="top-section-viewer special">
            ...
            <a href="<?php echo esc_url( home_url() ); ?>/dayservice-azukizaka/">
                ...
                <div class="font14 mt-2">愛知県岡崎市羽根町小豆坂87番地</div>
            </a>
            <a href="<?php echo esc_url( home_url() ); ?>/dayservice-umezono/">
                ...
                <div class="font14 mt-2">愛知県岡崎市六供町2丁目3-2</div>
            </a>
        </div>
        ...
        <div class="top-section-viewer">
            <a href="<?php echo esc_url( home_url() ); ?>/dayservice-tenma/">
                ...
                <div class="font14 mt-2">愛知県岡崎市伝馬通1丁目78番地（サンケアレジデンス内）</div>
            </a>
            <a href="<?php echo esc_url( home_url() ); ?>/dayservice-hakken/">
                ...
                <div class="font14 mt-2">愛知県安城市東端町八剱74番地2</div>
            </a>
            <a href="<?php echo esc_url( home_url() ); ?>/dayservice-hane/">
                ...
                <div class="font14 mt-2">愛知県岡崎市羽根北町一丁目３番地２</div>
            </a>
        </div>
    </section>
