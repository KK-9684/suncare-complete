...
<main class="top-page">
    ...
    <section class="sancare-section-wrapper pt-0" style="max-width: 1080px">
        <div class="grid-two-column">
            <div>
                <h2 class="font25 font-serif">長い木で、長い生きを。<br>温もりに包まれた心地よいケアをご提供します。</h2>
                <p class="font16 pt-2">
                    デイサービスセンター燦
    ...
    <section class="sancare-section-wrapper" style="max-width:1080px">
        ...
        <div class="grid-column-4">
            <div>
                ...
                <?php endif; ?>
                <p class="pt-4 font18 font-serif">「笑顔」があふれる心のこもったケア</p>
                <p>木の香りが漂う温かい空間で、最新のマッサージ機を使ったリラクゼーションが好評です。スタッフは一人ひとりに合わせた個別ケアを行い、利用者様の自立を支援します。スタッフの温かい対応により、他の施設では難しかった方も楽しく通えるようになっています。
                </p>
            </div>
            <div>
            ...
            <div>
                ...
                <?php endif; ?>
                <p class="pt-4 font18 font-serif">完全個浴で自宅のような安心感</p>
                <p>完全個浴の3つのお風呂を用意し、利用者様お一人ずつの着替えと入浴をサポートしています。大勢での入浴が苦手な方でも安心してリラックスできる環境です。普段は会話が苦手な方も、入浴時には自然とコミュニケーションが生まれ、リラックスした雰囲気の中で会話が弾むこともあります。
                </p>
            </div>
        </div>
    </section>
