...
<main class="top-page">
    ...
    <section class="sancare-section-wrapper" style="max-width: 1240px">
        <div class="grid-two-column">
            <div>
                <h3 class="font-serif" style="margin-left:-15px">「選ぶ・為す・繋がる」その人らしさを</h3>
                <h3 class="font-serif">大切にしたケアを提供します。</h3>
                <p class="font16 pt-4">
                    木の香あふれるゆったりとした空間で、笑顔あふれるスタッフたちによる個別ケアを重視した、安心のサービスをお届けします。
                    『選ぶ』『為す』『繋がる』を理念に掲げ、利用者様の個性、その人らしさを大切にしたケアを提供させて頂きます。
                </p>
            </div>
            <div>
    ...
    <section class="sancare-section-wrapper">
        ...
        <div class="my-3 google-map">
            ...
            <div class="mt-3">所在地：〒444-1213　愛知県岡崎市羽根北町一丁目３番地２　（Googleマップで見る）</div>
        </div>
    </section>
    <div class="bg-color-lr-red container-fluid">
        <section class="sancare-section-wrapper">
            <div class="grid-two-column-3 mt-0">
                ...
                <div class="bg-image-center"
                    style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/img/bottoms/hane-bottom.jpg)">
                </div>
            </div>
        </section>
    </div>
