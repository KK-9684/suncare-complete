    ...
    <section class="sancare-section-wrapper pt-0">
        <div class="grid-two-column">
            ...
            <div>
                ...
                <h3 class="font-serif font20 mt-3">自宅のように快適に過ごせる清潔感あふれる居室をご用意しています。</h3>
                <p class="pt-2">
                    グループホーム燦
        ...
        <div class="grid-two-column column-reverse">
            <div>
                ...
                <h3 class="font-serif font20 mt-3">笑い声が絶えない環境で、自立を尊重しながら心のこもった介護をご提供いたします。</h3>
                <p class="pt-2">
        ...
        <div class="grid-two-column">
            ...
            <div>
                ...
                <div class="font-serif font20 mt-3">医療連携をしっかりと整え、安心して過ごせるケアをご提供しています。</div>
                <p class="pt-2">
        ...
        <div class="grid-two-column column-reverse">
            <div>
                ...
                <div class="font-serif font20 mt-3">家庭菜園の恵みを取り入れた手作りの食事で、毎日楽しみにしていただいております。</div>
                <p class="pt-2">
        ...
        <div class="grid-two-column">
            ...
            <div>
                ...
                <div class="font-serif font20 mt-3">四季折々のイベントと多彩なレクリエーションで、毎日笑顔をお届けしています。</div>
                <p class="pt-2">
