...
<main class="top-page">
    ...
    <div class="sancare-top-img">
        ...
        <img src="<?php echo esc_url($image[0]['url']); ?>" alt="グループホーム燦 むつみ" loading="lazy">
        <?php endif; ?>
    </div>
    <section class="sancare-section-wrapper pt-0" style="max-width: 1240px">
        <div class="grid-two-column">
            ...
            <div>
                ...
                <img src="<?php echo esc_url($image[1]['url']); ?>" alt="グループホーム燦 むつみ" loading="lazy">
                <?php endif; ?>
            </div>
        </div>
    </section>
    ...
    <section class="sancare-section-wrapper pt-0">
        <div class="grid-two-column">
            <div>
                ...
                <img src="<?php echo esc_url($image[2]['url']); ?>" alt="グループホーム燦 むつみ" loading="lazy">
                <?php endif; ?>
            </div>
            <div>
        ...
        <div class="grid-two-column column-reverse">
            <div>
                ...
                <h3 class="font-Pr6N font20 mt-4 mb-2 pc">笑い声が絶えない環境で、自立を尊重しながら心のこもった介護をご提供いたします。</h3>
                <h3 class="font-Pr6N font20 mt-4 mb-2 sp">笑い声が絶えない環境で、<br>自立を尊重しながら<br>心のこもった介護をご提供いたします。</h3>
                <p class="font14 pt-2">
            ...
            <div>
                ...
                <img src="<?php echo esc_url($image[3]['url']); ?>" alt="グループホーム燦 むつみ" loading="lazy">
                <?php endif; ?>
            </div>
        </div>
        <div class="grid-two-column">
            <div>
                ...
                <img src="<?php echo esc_url($image[4]['url']); ?>" alt="グループホーム燦 むつみ" loading="lazy">
                <?php endif; ?>
            </div>
            <div>
        ...
        <div class="grid-two-column column-reverse">
            <div>
                ...
                <div class="font-Pr6N font20 mt-4 mb-2 pc">家庭菜園の恵みを取り入れた手作りの食事で、毎日楽しみにしていただいております。</div>
                <div class="font-Pr6N font20 mt-4 mb-2 sp">家庭菜園の恵みを取り入れた<br>手作りの食事で、<br>毎日楽しみにしていただいております。</div>
                <p class="font14 pt-2">
            ...
            <div>
                ...
                <img src="<?php echo esc_url($image[5]['url']); ?>" alt="グループホーム燦 むつみ" loading="lazy">
                <?php endif; ?>
            </div>
        </div>
        <div class="grid-two-column">
            <div>
                ...
                <img src="<?php echo esc_url($image[6]['url']); ?>" alt="グループホーム燦 むつみ" loading="lazy">
                <?php endif; ?>
            </div>
            <div>
                <div class="font-Pr6N font31">05.アクティビティ</div>
                <div class="font-Pr6N font16">ACTIVITY</div>
                <div class="font-Pr6N font20 mt-4 mb-2 pc">四季折々のイベントと多彩なレクリエーションで、毎日笑顔をお届けしています。</div>
                <div class="font-Pr6N font20 mt-4 mb-2 sp">四季折々のイベントと<br>多彩なレクリエーションで、<br>毎日笑顔をお届けしています。</div>
                <p class="font14 pt-2">
    ...
    <div class="bg-color-mr-blue container-fluid">
        <section class="sancare-section-wrapper" style="max-width: 820px">
            <div class="bottom-grid mt-0">
                ...
                <img src="<?php echo esc_url($image[7]['url']); ?>" alt="グループホーム燦 むつみ" loading="lazy">
                <?php endif; ?>
            </div>
        </section>
    </div>
