    ...
    <section class="sancare-section-wrapper pt-0">
        ...
        <div class="grid-two-column">
            ...
            <div>
                ...
                <h3 class="font-Pr6N font20 mt-4 mb-2 pc">週1回の定期訪問診療と24時間365日医療体制で、安心してお過ごしいただける環境を整えています。</h3>
                <h3 class="font-Pr6N font20 mt-4 mb-2 sp">週1回の定期訪問診療と<br>24時間365日医療体制で、<br>安心してお過ごしいただける<br>環境を整えています。
                </h3>
                <p class="font14 pt-2">
